            ...
            {Object.keys(products).map((item) => {
              return (
                <div
                  ...
                  className="lg:w-1/4 shadow-xl p-2 hover:shadow-2xl min-w-full"
                >
                  <Link
                  ...
                  <div className="mt-4 text-center md:text-left p-2">
                    <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">
                      {/* {products[item].category} */}T-Shirts
                    </h3>
                    ...
                    {/* <div className="mt-1">
                      {products[item].color.map((c) => {
                        {
                          console.log(`bg-${c.toLowerCase()}-700`);
                        }
                        return (
                          <button
                            key={c}
                            className={`border-2 border-gray-300 ml-1 bg-${c.toLowerCase()}-700 rounded-full w-6 h-6 focus:outline-none`}
                          ></button>
                        );
                      })}
                    </div> */}
