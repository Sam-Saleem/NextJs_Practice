...
const Checkout = ({
  ...
  return (
    <div className="conatiner m-auto px-8 md:px-20 py-10">
      ...
      <div className="sideCart bg-pink-100 p-5 shadow-lg rounded-lg ">
        ...
        <div className="font-bold text-end my-5 mr-2 md:mr-4 lg:mr-10">
        ...
        <Link href={"/order"}>
          <button
            ...
            className="flex mx-auto text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-600 rounded disabled:bg-pink-400 shadow-xl"
          >
